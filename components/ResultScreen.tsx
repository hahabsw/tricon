          ...
          <div className="relative z-10 flex flex-col items-center">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-3 sm:space-x-6 min-w-0">
                      <span className="font-mono text-2xl sm:text-4xl font-black text-white/20 tabular-nums shrink-0">#{rank.rank}</span>
                      <div className="flex items-center gap-3 min-w-0">
                        <span
                          className="inline-block w-3 h-3 rounded-full shrink-0"
                          style={{
                            backgroundColor: color,
                            boxShadow: isMe ? `0 0 10px ${color}, 0 0 20px ${color}` : "none",
                          }}
                        />
                        <span className="text-base sm:text-xl font-bold tracking-tight text-white flex items-center gap-2 sm:gap-3 flex-wrap min-w-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <button
                ...
                className="relative overflow-hidden w-full sm:w-auto px-8 sm:px-12 py-4 sm:py-6 bg-white/10 hover:bg-white/20 transition-all rounded-full font-black text-sm sm:text-base uppercase tracking-widest border border-white/20"
              >
              ...
              <button
                onClick={handleLeave}
                className="relative overflow-hidden w-full sm:w-auto px-10 sm:px-16 py-4 sm:py-6 bg-white text-black hover:bg-gray-200 transition-all rounded-full font-black text-base sm:text-xl uppercase tracking-widest shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_rgba(255,255,255,0.5)] active:scale-95"
              >
