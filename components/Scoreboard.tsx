...
export const Scoreboard = () => {
  ...
  return (
    <div className="absolute top-6 left-0 right-0 z-10 flex justify-center pointer-events-none">
      <div className="glass px-8 py-4 rounded-full flex items-center space-x-12 border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.5)] bg-black/40 backdrop-blur-xl">
          ...
          return (
            <div 
              ...
              className={`flex items-center space-x-4 transition-all duration-300 ${
                isActive ? "scale-110 opacity-100" : "scale-100 opacity-50 grayscale hover:grayscale-0"
              }`}
            >
              <div 
